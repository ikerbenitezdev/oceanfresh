...
const copyByLocale: Record<Locale, ContactCopy> = {
  es: {
    ...
    title: "Contacto",
    description:
      "¿Eres importador, distribuidor o trabajas en el sector HORECA? Cuéntanos tus necesidades y te respondemos en menos de 24 horas.",
    ...
    policy:
      "Al enviar este formulario, aceptas nuestra política de privacidad. Tus datos nunca serán cedidos a terceros.",
    contactInfo: "Información de contacto",
    emailTitle: "Email",
    phoneTitle: "Teléfono / WhatsApp",
    exportTitle: "Exportamos a",
    exportTo: "UE, Asia, América del Norte y del Sur",
    ...
    saturday: "Sábados: 09:00 - 13:00 (CET)",
    placeholders: {
      name: "Tu nombre",
      email: "tu@empresa.com",
      country: "España, Francia, Italia...",
      company: "Nombre de tu empresa (opcional)",
      message: "Describe qué producto te interesa, volumen aproximado, frecuencia de pedido...",
    },
  },
  en: {
