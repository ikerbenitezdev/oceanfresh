...
const homeCopy: Record<Locale, HomeCopy> = {
  ...
  en: {
    ...
    certCtaDesc: "We provide ONISPA certificate, EUR.1, and origin declaration.",
    ...
    valueItems: [
      ...
      "EUR1 and sanitary documentation included.",
    ],
  ...
  fr: {
    ...
    certCtaDesc: "Nous envoyons certificat ONISPA, EUR.1 et declaration d'origine.",
    ...
    valueItems: [
      ...
      "Documents EUR1 et certificats sanitaires inclus.",
    ],
  ...
  ar: {
    ...
    certCtaDesc: "نوفر شهادة ONISPA و EUR.1 وشهادة المنشأ.",
